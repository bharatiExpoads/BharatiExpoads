...
const CreditNoteMaster = () => {
  ...
  const fetchNotes = async () => {
    ...
    setError(null);
    try {
      const data = await masterService.getAllCreditNotes();
      setNotes(data);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedNote) {
        await masterService.updateCreditNote(selectedNote.id, cleanData);
      } else {
        await masterService.createCreditNote(cleanData);
      }
  ...
  const handleDelete = async () => {
    ...
    try {
      await masterService.deleteCreditNote(selectedNote.id);
      fetchNotes();
    ...
    <Layout>
      <div className="container mx-auto py-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold">Credit Note Master</h2>
        </div>
        ...
        <Modal
          ...
          title={selectedNote ? 'Edit Credit Note' : 'Add Credit Note'}
        >
